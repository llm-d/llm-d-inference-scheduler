...
export EPP_IMAGE="${EPP_IMAGE:-ghcr.io/llm-d/router-endpoint-picker:${EPP_TAG}}"
export VLLM_IMAGE="${VLLM_IMAGE:-ghcr.io/llm-d/llm-d-inference-sim:${VLLM_SIMULATOR_TAG}}"
export SIDECAR_IMAGE="${SIDECAR_IMAGE:-ghcr.io/llm-d/router-disagg-sidecar:${SIDECAR_TAG}}"
