...
// Package httperrors provides functions to send error responses to the client
package httperrors
...
// ErrorResponse is the error response for the vLLM errors
