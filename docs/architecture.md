...
Selects the profiles to use when running with disaggregation and sets the prefill/encode routing headers (previously handled by the now-removed `disagg-headers-handler` plugin).
