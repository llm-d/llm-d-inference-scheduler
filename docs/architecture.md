...
See list of parameters at [llm-d-kv-cache-manager/docs/configuration.md](https://github.com/llm-d/llm-d-kv-cache-manager/blob/926f5b2e1bf7b6c0cce587783753393b6e65d4a1/docs/configuration.md).
...
- Token processor's block-size and hash-seed to match those used in vLLM pods.
...
```yaml
{
  "indexerConfig": {
    "tokenProcessorConfig": {
      "blockSize": 64, # if vLLM is not using the default block size of 16
      "hashSeed": "12345" # matching the PYTHONHASHSEED env-var in vLLM pods
    },
