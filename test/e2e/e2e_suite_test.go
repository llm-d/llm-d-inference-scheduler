...
var (
	...
	eppImage          = env.GetEnvString("EPP_IMAGE", "ghcr.io/llm-d/router-endpoint-picker:dev", ginkgo.GinkgoLogr)
	vllmSimImage      = env.GetEnvString("VLLM_IMAGE", "ghcr.io/llm-d/llm-d-inference-sim:v0.8.2", ginkgo.GinkgoLogr)
	sideCarImage      = env.GetEnvString("SIDECAR_IMAGE", "ghcr.io/llm-d/router-disagg-sidecar:dev", ginkgo.GinkgoLogr)
